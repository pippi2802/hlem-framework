...
if __name__ == '__main__':
    ...
    bpi2017_path = os.path.join(current_dir, "event_logs/BPI2018_short.xes")
    ...
    class_under_250, class_over_250 = preprocessing.partition_on_throughput_2cats(log)
    ...
    results_analysis.throughput_tables(df_paths, [class_under_250, class_over_250])
